    ...
    for (let attempt = 1; attempt <= MAX_RETRIES; attempt++) {
        try {
            ...
            const specificRules = "### REGRAS ESPECIAIS:\n" +
                ...
                "- DIRETRIZ DE PRECIFICAÇÃO PROATIVA: Toda vez que você confirmar a disponibilidade, oferecer, listar ou recomendar um produto que foi encontrado no seu Contexto de Estoque, VOCÊ DEVE OBRIGATORIAMENTE informar o preço dele imediatamente na mesma mensagem. NUNCA espere o cliente perguntar \"quanto custa?\". Aja como um vendedor ágil no balcão: apresente a solução e o valor na mesma frase.\n" +
