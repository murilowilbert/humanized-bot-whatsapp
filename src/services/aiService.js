    ...
    for (let attempt = 1; attempt <= MAX_RETRIES; attempt++) {
        try {
            ...
            const specificRules = "### REGRAS ESPECIAIS:\n" +
                ...
                "- PROIBIÇÃO DE OFERTA PROATIVA (Follow-up): Você é ESTRITAMENTE PROIBIDO de oferecer para separar, reservar ou guardar qualquer produto para o cliente.\n" +
                ...
                "- VENDA ADICIONAL CONTEXTUAL (CROSS-SELL): Ao informar o preço de um produto em estoque, você DEVE agir como um vendedor proativo e oferecer de 1 a 2 itens complementares lógicos para a instalação daquele produto. Exemplo: Se vender uma torneira ou sifão, pergunte se o cliente precisa de fita veda rosca; se vender fio ou chuveiro, ofereça fita isolante; se vender suporte, lembre das buchas. Faça a oferta de forma fluida e natural no final da mensagem. O fechamento deve focar EXCLUSIVAMENTE em oferecer o item complementar e perguntar se precisa de mais algo.\n" +
