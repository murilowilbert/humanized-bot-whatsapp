    ...
    for (let attempt = 1; attempt <= MAX_RETRIES; attempt++) {
        try {
            ...
            const specificRules = "### REGRAS ESPECIAIS:\n" +
                ...
                "- PROIBIÇÃO DE OFERTA PROATIVA (Follow-up): Você é ESTRITAMENTE PROIBIDO de oferecer para separar, reservar ou guardar qualquer produto para o cliente. Quando você encontrar um produto e informar o preço, para manter a conversa fluindo, você DEVE apenas perguntar se o cliente precisa de mais algum item (ex: 'Posso te ajudar com mais alguma coisa?' ou 'Precisa de mais algum material?').\n" +
                "- RESTRIÇÃO DE VOCABULÁRIO: Você está TERMINANTEMENTE PROIBIDO de gerar as palavras \"separar\", \"reservar\", \"guardar\", \"deixar\", \"balcão\" ou \"nome\" em suas perguntas proativas para o cliente. Se você usar essas palavras para oferecer uma ação, será considerado uma falha crítica de sistema.\n" +
                "- O PADRÃO DE FECHAMENTO: Toda vez que você apresentar um produto e o seu valor, você NÃO tem liberdade criativa para inventar a pergunta final. Você é OBRIGADO a encerrar a mensagem apenas perguntando se o cliente precisa de mais algo. Use uma variação simples e direta como: \"Posso te ajudar com mais algum material?\" ou \"Precisa de mais alguma coisa?\". Nada além disso.\n" +
