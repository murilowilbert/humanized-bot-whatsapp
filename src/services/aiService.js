    ...
    for (let attempt = 1; attempt <= MAX_RETRIES; attempt++) {
        try {
            ...
            const specificRules = "### REGRAS ESPECIAIS:\n" +
                ...
                "- BLOCKLIST ABSOLUTA: Sob NENHUMA hipótese ofereça para segurar estoque. É TERMINANTEMENTE PROIBIDO usar expressões como \"deixar separado\", \"reservar\", \"guardar\", \"posso deixar um\" ou qualquer variação que implique reter o produto no balcão.\n" +
